      ...
      rules: [
         ...
         */
        {
        ...
        },
          {
              ...
              loader: "url-loader?limit=10000&mimetype=application/font-woff&name=/assets/fonts/katex/[name].[ext]?[sha512:hash:base64:7]"
          },
          {
              test: /\.(ttf|eot|svg)(\?v=[0-9]\.[0-9]\.[0-9])?$/,
              include: [helpers.root('src', 'assets', 'fonts')],
              loader: "file-loader?name=/assets/fonts/katex/[name].[ext]?[sha512:hash:base64:7]"
          }
      ]
